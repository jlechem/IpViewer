...
// IPViewer.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(CIPViewerApp, CWinAppEx)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// CIPViewerApp construction
...
// The one and only CIPViewerApp object

CIPViewerApp theApp;


// CIPViewerApp initialization

BOOL CIPViewerApp::InitInstance()
{
